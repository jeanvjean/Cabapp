...
router.get('/change-cylinders-status', auth.verify(), production_1.Validator.cylindersStatusChange(), val.validate(), controllers_1.productionCtrl.markFilledCylinders());
