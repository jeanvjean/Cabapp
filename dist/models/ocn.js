...
const ocnSchema = new mongoose_1.Schema({
    ...
    invoice: { type: mongoose_1.Schema.Types.ObjectId, ref: 'reciept' },
    totalQty: Number,
    totalVol: {
        value: Number,
        unit: String
    ...
    routePlan: { type: mongoose_1.Schema.Types.ObjectId, ref: "pickup-routes" },
    closed: { type: Boolean, default: false },
    delivery_ids: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "waybill" }],
