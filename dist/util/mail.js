        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let messagePayload = {
                    messages: [
                        {
                            from: static_1.default.INFOBIP_FROM,
                            destinations: [
                                { to: payload.to }
                            ],
                ...
                let response = yield axios_1.default.post(`${static_1.default.INFOBIP_URL}sms/2/text/advanced`, messagePayload, {
                    headers: {
                        'Content-Type': 'application/json',
                        Authorization: `App ${static_1.default.INFOBIP_API_KEY}`
                    }
                });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                var data = {
                    ...
                    sms: payload.message,
                    type: "plain",
                    api_key: static_1.default.TERMII_API_KEY,
                    channel: "generic",
                };
                var options = {
                    'method': 'POST',
