...
class VehicleController extends ctrl_1.default {
    ...
    marAsCompletedRoutePlan() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield this.module.marAsCompletedRoutePlan(req.params.routeId);
    ...
    addTerritory() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                //@ts-ignore
                const data = yield this.module.addTerritory(req.body, req.user);
                this.ok(res, 'done', data);
            }
            catch (error) {
    ...
    fetchTerritory() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                //@ts-ignore
                const data = yield this.module.fetchTerritory(req.query, req.user);
                this.ok(res, 'done', data);
            }
            catch (error) {
                this.handleError(error, req, res);
    ...
    deleteTerretory() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield this.module.deleteTerretory(req.params.terretoryId);
                this.ok(res, 'done', data);
            }
            catch (error) {
                this.handleError(error, req, res);
