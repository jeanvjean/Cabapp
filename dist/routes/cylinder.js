...
router.get('/download-cylinder-form', controllers_1.cylinderCtrl.downloadCylinderCsv());
router.post('/register-multiple-cylinders', auth.verify(), controllers_1.cylinderCtrl.registerMultipleCylinders());
