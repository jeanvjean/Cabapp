...
class CylinderController extends ctrl_1.default {
    ...
    downloadCylinderCsv() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield this.module.downloadCylinderCsv();
                res.header('Content-Type', 'text/csv');
                res.attachment(`${token_1.formatDate(new Date().toISOString())
                    .split('/')
                    .join('.')}.cylinders.csv`);
                console.log(data);
                res.send(data);
    ...
    registerMultipleCylinders() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (!req.files) {
                    throw new exceptions_1.BadInputFormatException('file is required');
                }
                //@ts-ignore
                const data = yield this.module.registerMultipleCylinders(req.files.file, req.user);
    ...
    fetchCylinderWithScan() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                //@ts-ignore
                const data = yield this.module.fetchCylinderWithScan(req.query, req.user);
                this.ok(res, 'fetched', data);
            }
            catch (e) {
                this.handleError(e, req, res);
