...
class Cylinder extends module_1.default {
    ...
    downloadCylinderCsv() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let data = [];
                let form = token_1.toCSV({ fields, data });
                return form;
            }
            catch (error) {
    ...
    registerMultipleCylinders(file, user) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const files = file;
                let path = './temp';
                ...
                //@ts-ignore
                let filepath = yield files.mv(path + '/' + files.name);
                const cylinders = yield csv().fromFile(filepath);
                //@ts-ignore
                unlinkSync(path + '/' + files.name);
                for (let cyl of cylinders) {
                    let customer;
                    if (cyl.cylinderType == cylinder_1.cylinderTypes.ASSIGNED) {
                        customer = yield this.customer.findOne({ email: cyl.assignedTo });
                    }
                    yield this.regCylinder(Object.assign(Object.assign({}, cyl), { assignedTo: customer === null || customer === void 0 ? void 0 : customer._id }), user);
                }
                ...
                if (data.status == transferCylinder_1.ApprovalStatus.REJECTED) {
                    ...
                    if ((change === null || change === void 0 ? void 0 : change.approvalStage) == transferCylinder_1.stagesOfApproval.START) {
                        ...
                        for (let cyl of cylinders) {
                            ...
                            if ((changeCyl === null || changeCyl === void 0 ? void 0 : changeCyl.cylinderType) == cylinder_1.cylinderTypes.ASSIGNED) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (lastOcn[0]) {
                    ...
                    let lastDn = yield this.waybill.findOne({
                        ocn: lastOcn[0]._id
                    });
    ...
    cylinderStats(user) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const bufferCylinder = cylinders.filter(cylinder => cylinder.cylinderType == cylinder_1.cylinderTypes.BUFFER).length;
                const assignedCylinder = cylinders.filter(cylinder => cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED).length;
                ...
                const customerBufferCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.CUSTOMER && cylinder.cylinderType == cylinder_1.cylinderTypes.BUFFER).length;
                const customerAssignedCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.CUSTOMER && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED).length;
                const asnlBufferCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderType == cylinder_1.cylinderTypes.BUFFER).length;
                const asnlAssignedCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED).length;
                ...
                const filledBufferCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderStatus == walk_in_customers_1.WalkinCustomerStatus.FILLED && cylinder.cylinderType == cylinder_1.cylinderTypes.BUFFER).length;
                const filledAssignedCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderStatus == walk_in_customers_1.WalkinCustomerStatus.FILLED && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED).length;
                const emptyBufferCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderStatus == walk_in_customers_1.WalkinCustomerStatus.FILLED && cylinder.cylinderType == cylinder_1.cylinderTypes.BUFFER).length;
                const emptyAssignedCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderStatus == walk_in_customers_1.WalkinCustomerStatus.FILLED && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED).length;
                const faultyFilledCustomerCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.CUSTOMER && cylinder.cylinderStatus == walk_in_customers_1.WalkinCustomerStatus.FILLED && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED && cylinder.condition == cylinder_1.CylinderCondition.FAULTY).length;
                const faultyEmptyCustomerCylinders = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.CUSTOMER && cylinder.cylinderStatus == walk_in_customers_1.WalkinCustomerStatus.EMPTY && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED && cylinder.condition == cylinder_1.CylinderCondition.FAULTY).length;
                ...
                const asnlTotalGoodBuffer = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderType == cylinder_1.cylinderTypes.BUFFER && cylinder.condition == cylinder_1.CylinderCondition.GOOD).length;
                const asnlTotalBadBuffer = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderType == cylinder_1.cylinderTypes.BUFFER && cylinder.condition == cylinder_1.CylinderCondition.FAULTY).length;
                const asnlTotalGoodAssigned = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED && cylinder.condition == cylinder_1.CylinderCondition.GOOD).length;
                const asnlTotalBadAssigned = cylinders.filter(cylinder => cylinder.holder == registeredCylinders_1.cylinderHolder.ASNL && cylinder.cylinderType == cylinder_1.cylinderTypes.ASSIGNED && cylinder.condition == cylinder_1.CylinderCondition.FAULTY).length;
                        ...
                        if (transfer.type == transferCylinder_1.TransferType.TEMPORARY) {
                            for (let cylinder of cylinders) {
                                ...
                                if (cyl) {
                                    ...
                                    //@ts-ignore
                                    cyl === null || cyl === void 0 ? void 0 : cyl.cylinderType = cylinder_1.cylinderTypes.ASSIGNED;
                                    //@ts-ignore
    ...
    fetchCustomerCylinders(query, customerId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (status) {
                    //@ts-ignore
                    q = Object.assign(Object.assign({}, q), { cyliderStatus: status });
                }
                if (or.length > 0) {
                    //@ts-ignore
                    q = Object.assign(Object.assign({}, q), { $or: or });
