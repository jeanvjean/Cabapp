...
class User extends module_1.default {
    ...
    inviteUser(data, userInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(branch === null || branch === void 0 ? void 0 : branch.branch);
                const exists = [];
                    ...
                    if (existUser) {
                        ...
                        if (user.subrole == 'head of department') {
                            ...
                            if (!hod) {
                                let password = yield token_1.generateToken(4);
                                //@ts-ignore
                                yield this.user.create(Object.assign(Object.assign({}, user), { branch: branch.branch._id, password }));
                                const html = yield resolve_template_1.getTemplate('invite', {
                                    team: user.role,
                                    role: user.subrole,
                                    email: user.email,
    ...
    login(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!user) {
                    throw new exceptions_1.BadInputFormatException('Invalid credentials');
                }
                // if(!user.isVerified) {
                ...
                let token = jsonwebtoken_1.sign(payload, exports.signTokenKey, { expiresIn: "180d" });
                yield logs_1.createLog({
                    user: user._id,
                    activities: {
                        title: 'Logged in',
    ...
    fetchUserAuth(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user) {
                throw new exceptions_1.BadInputFormatException('Authorization error');
            }
            return Promise.resolve(user);
        });
    }
