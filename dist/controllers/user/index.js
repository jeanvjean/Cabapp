...
class UserController extends ctrl_1.default {
    ...
    fetchUsers() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                //@ts-ignore
                const data = yield this.module.fetchUsers(Object.assign({}, req.query), req.user);
    ...
    branchUsers() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                //@ts-ignore
                const data = yield this.module.branchUsers(Object.assign({}, req.query), req.user);
    ...
    fetchUserByEmail() {
        return (req, res) => __awaiter(this, void 0, void 0, function* () {
            const data = yield this.module.fetchUserByEmail(req.params.email);
