...
router.get('/complete-route-plan', auth.verify(), controllers_1.vehicleCtrl.marAsCompletedRoutePlan());
router.post('/add-terretory', auth.verify(), controllers_1.vehicleCtrl.addTerritory());
router.get('/fetch-terretories', auth.verify(), controllers_1.vehicleCtrl.fetchTerritory());
router.delete('/delete-terretory/:terretory_id', auth.verify(), controllers_1.vehicleCtrl.deleteTerretory());
